...
plt.ylabel('Loss(MSE)')
plt.title("Asset Risk\n Training Loss")
plt.show()
            
            
            
plt.plot(loss_test[2:5000])
plt.xlabel('Number of Iterations')
plt.ylabel('Loss(MSE)')
plt.title("Asset Risk\n Test Set Loss")
plt.axhline(y= 0.45243168)
plt.axvline(x= 671)
plt.show()         
            

plt.plot(loss_valid[2:5000])
plt.xlabel('Number of Iterations')
plt.ylabel('Loss(MSE)')
plt.title("Asset Risk\n Validation Set Loss")
plt.axhline(y= 0.51008487 )
plt.axvline(x= 655)
plt.show()         
                       
            
plt.plot(loss_ledger[0])
plt.xlabel('Number of Iterations')
plt.ylabel('Loss(MSE)')
plt.title("Capital-Asset ratio\n Without lagged variables\n  Batch Size = 150")
plt.axhline(y=   0.059946943 )
plt.axvline(x= 4364)
plt.show()                   
